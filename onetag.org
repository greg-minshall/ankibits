...
#+BEGIN_SRC python :noweb yes :tangle ankiimport.py
  ...
  def doimport(col, deckname, ifilepath):
      tag = constag(args.deckname); # just run once!
  ...
  def main(argv):
      ...
      parser.add_argument("-R", "--superset", action="store_true", default=False,
          ...
          help="make sure all the notes in the input file end up in the Anki deck")
